...
// @version      0.1
// @description  It's an userscript prepared for uesrs who's Level is highter than Moderator
// @author       Rhilip
...
//Control Options
var IPv6toLocation = 1;

$(document).ready(function(){
    //IPv6 address to Location in page detail.php
    if (IPv6toLocation && location.pathname == "/details.php"){
        if ($('#peerlist').length && ($('#peercount').attr('style') == 'display: none;')){
